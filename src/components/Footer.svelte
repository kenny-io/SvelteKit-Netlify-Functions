<footer class="text-gray-600 body-font">
  ...
  >
    ...
    >
      This site is designed by <a
        class="text-appaccent font-bold underline"
        href="https://twitter.com/urluchy">Ursula</a
      >
      and built by
      <a
        class="text-appaccent font-bold underline"
        href="https://twitter.com/kenny_io">Ekene.</a
      > <br />
      It's hosted on
      <a
        class="text-appaccent font-bold underline"
      ...
      <a
        ...
        class="text-appaccent font-bold underline">Dusty Domains project.</a
      > <br />
